...
/**
 * Import Party via intermediate DataImportParty entity.
 */
public interface PartyImportServiceInterface extends ServiceInterface{
    
    /**
     * Gets imported records count by service {@link #importParty}.
