...
<#if accounts?has_content>
  ...
  <table>
    <tr>
       <td colspan="2" class="tableheadtext" align="right">${uiLabelMap.FinancialsComparativeIncomeStatement}  ${parameters.organizationName?if_exists} (${organizationPartyId})</td>
    </tr>
    <tr><td>&nbsp;</td></tr>
    <tr>
