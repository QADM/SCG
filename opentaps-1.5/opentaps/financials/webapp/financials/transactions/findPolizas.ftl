...
<form name="buscarPolizasContables" method="post" action="">
  ...
  <table class="twoColumnForm">
    <tbody>
      ...
      <@inputSelectRow title=uiLabelMap.FinancialsTipoPoliza required=false list=listaTipoPoliza  displayField="tipoPoliza" name="tipoPoliza" default=idTipoDoc?if_exists />
