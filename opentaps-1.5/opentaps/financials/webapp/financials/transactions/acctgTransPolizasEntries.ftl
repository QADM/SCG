...
<div class="screenlet-header">
  ...
  <span class="boxhead">Detalles de la Póliza</span>
</div>

  <#if acctgTrans?exists>
    <table class="listTable" cellspacing="0" style="border:none;">
      <tr class="listTableHeader">
        <td><span>Secuencia</span></td>
        <td><span>Cuenta Contable</span></td>
		<td><span>CRI/COG</span></td>
        <td><span>Debe/Haber</span></td>
		<td></td>
      ...
      <#if acctgTrans.isPosted == "Y">
        <#list acctgTransEntries as entry>
          <tr class="${tableRowClass(entry_index)}">
            ...
            <td><#assign glAccount = entry.getRelatedOneCache("GlAccount")/><a class="linktext" href="<@ofbizUrl>AccountActivitiesDetail?glAccountId=${glAccount.glAccountId}&amp;organizationPartyId=${session.getAttribute("organizationPartyId")}</@ofbizUrl>">${glAccount.accountCode?default(glAccount.glAccountId)}</a></td>
			<td></td>			
