...
public class LedgerRepository extends Repository implements LedgerRepositoryInterface {
    ...
    public AcctgTransPresupuestal getAccountingTransactionPresupuestal(String acctgTransId) throws RepositoryException {
        try {
            return findOneNotNull(AcctgTransPresupuestal.class, map(AcctgTransPresupuestal.Fields.acctgTransId, acctgTransId), "Accounting Transaction [" + acctgTransId + "] not found.");
        } catch (GeneralException e) {
            throw new RepositoryException(e);
        }
    }
    ...
    public AcctgTransPresupuestalEg getAcctgTransPresupuestalEg(String acctgTransId) throws RepositoryException {
        try {
            return findOneNotNull(AcctgTransPresupuestalEg.class, map(AcctgTransPresupuestalEg.Fields.acctgTransId, acctgTransId), "Accounting Transaction [" + acctgTransId + "] not found.");
        } catch (GeneralException e) {
            throw new RepositoryException(e);
        }
    }

    public AcctgTransPresupuestalIng getAcctgTransPresupuestalIng(String acctgTransId) throws RepositoryException {
        try {
            return findOneNotNull(AcctgTransPresupuestalIng.class, map(AcctgTransPresupuestalIng.Fields.acctgTransId, acctgTransId), "Accounting Transaction [" + acctgTransId + "] not found.");
        } catch (GeneralException e) {
            throw new RepositoryException(e);
        }
    }
    ...
    public AcctgPolizasDetalle getAcctgPolizasDetalle(String acctgTransId) throws RepositoryException {
        try {
            return findOneNotNull(AcctgPolizasDetalle.class, map(AcctgPolizasDetalle.Fields.acctgTransId, acctgTransId), "Accounting Transaction [" + acctgTransId + "] not found.");
        } catch (GeneralException e) {
            throw new RepositoryException(e);
        }
    }
