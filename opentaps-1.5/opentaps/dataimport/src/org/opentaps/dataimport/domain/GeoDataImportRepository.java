...
/** {@inheritDoc}. */
public class GeoDataImportRepository extends DomainRepository implements GeoDataImportRepositoryInterface{
    
    /**
     * Default constructor.
     */
    public GeoDataImportRepository() {
        super();
    }
     ...
     */
    public GeoDataImportRepository(Infrastructure infrastructure, User user) throws RepositoryException {
        super(infrastructure, user);
    }

    /** {@inheritDoc}. */
    public List<DataImportGeo> findNotProcessesDataImportGeoEntries() throws RepositoryException {
        ...
        return this.findList(DataImportGeo.class, statusCond);
    }   
}
