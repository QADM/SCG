...
/** {@inheritDoc}. */
public class CategoryDataImportRepository extends DomainRepository implements CategoryDataImportRepositoryInterface{
    
    /**
     * Default constructor.
     */
    public CategoryDataImportRepository() {
        super();
    }
     ...
     */
    public CategoryDataImportRepository(Infrastructure infrastructure, User user) throws RepositoryException {
        super(infrastructure, user);
    }

    /** {@inheritDoc}. */
    public List<DataImportCategory> findNotProcessesDataImportCategoryEntries() throws RepositoryException {
        ...
        return this.findList(DataImportCategory.class, statusCond);
    }   
}
